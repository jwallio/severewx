...
from severewx.ingest.stage_gfs import NOAA_GRIB_SOURCE_SPECS, stage_historical_gfs, staging_defaults_from_settings
...
def main() -> None:
    ...
    parser.add_argument("--source-strategy", choices=["auto", "open_meteo_recent", *sorted(NOAA_GRIB_SOURCE_SPECS)], default="auto")
    ...
    elif args.source_strategy in {"auto", "ncei_historical", "aws_recent", "open_meteo_recent"}:
